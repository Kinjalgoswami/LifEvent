...
--
-- Table structure for table `tblvenuetype`
--
...
INSERT INTO `tblvenuetype` (`ID`, `VenueType`, `CreationDate`) VALUES
(1, 'Vivanta', '2020-01-22 07:01:39'),
(2, 'Birthday Party', '2020-01-22 07:02:34'),
(3, 'Charity', '2020-01-22 07:02:43'),
(4, 'Cocktail', '2020-01-22 07:03:00'),
(5, 'College', '2020-01-22 07:03:11'),
...
CREATE TABLE `tblservice` (
  ...
  `ServiceView` varchar(200) DEFAULT NULL,
  `CreationDate` timestamp NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Indexes for table `tblvenuetype`
--
ALTER TABLE `tblvenuetype`
  ADD PRIMARY KEY (`ID`),
  ADD KEY `EventType` (`VenueType`);  
...
--
-- AUTO_INCREMENT for table `tblvenuetype`
--
ALTER TABLE `tblvenuetype`
  MODIFY `ID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;  
