...
<div class="header">
     <div class="container">
         <div class="logo">
             <a href="index.php"><h1>Service Details</h1></a>
         </div>
         
         <div class="clearfix"></div>
     </div>
</div>
    <body class="cnt-home" style="background-image: url(img/kkkk.jpg")>
...
<?php if($row['productAvailability']=='In Stock'){?>
										<a href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary"> Book Service</a>
													<?php } else {?>
