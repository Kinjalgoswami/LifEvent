...
<html lang="en">
	<head>
	    ...
	    <title>Services| Signi-in | Signup</title>
...
<div class="col-md-6 col-sm-6 sign-in">
	<h4 class="" style="color: #fff;">sign in</h4>
	<p class="" style="color: #fff;">Hello, Welcome to your account.</p>
...
?>
		...
		<div class="radio outer-xs" style="color: #fff;">
...
<div class="col-md-6 col-sm-6 create-new-account" style="color: #fff;">
	<h4 class="checkout-subtitle">create a new account</h4>
	<p class="text title-tag-line" style="color: #fff;">Create your own Shopping account.</p>
