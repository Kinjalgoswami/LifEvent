                    ...
                    <div class="sidebar-content">
                            ...
                            <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                                ...
                                <div class="content-header-item">
                                    <a class="link-effect font-w700" href="dashboard.php">
                                        ...
                                        <span class="font-size-xl text-dual-primary-dark">Lif</span><span class="font-size-xl text-primary">Event</span>
                                    </a>
                                </div>
                                <!-- END Logo -->
                            </div>
                        ...
                        <div class="content-side content-side-full content-side-user px-10 align-parent">
                            ...
                            <div class="sidebar-mini-visible-b align-v animated fadeIn">
                                <img class="img-avatar img-avatar32" src="assets/img/avatars/download.png" alt="">
                            </div>
                            ...
                            <div class="sidebar-mini-hidden-b text-center">
                                <a class="img-link" href="be_pages_generic_profile.html">
                                    <img class="img-avatar" src="assets/img/avatars/download.png" alt="">
                                </a>
...
{               ?>
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
                                <li class="open">
                                    <a href="dashboard.php"><i class="si si-home"></i><span class="sidebar-mini-hide">Dashboards</span></a>
                               ...
                               <!-- <li>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="contactus.php">Contact Details</a>
                                        </li>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="todays-orders.php">New Booking</a>
                                        </li>
                                        <li>
                                            <a href="pending-orders.php">Pending order</a>
                                        </li>
                                        <li>
                                            <a href="manage-users.php">Booking users</a>
                                        </li>
                                        <li>
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-user"></i><span class="sidebar-mini-hide">Customer Queries</span></a>
                                    <ul>
                                        <li>
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-magnifier"></i><span class="sidebar-mini-hide">Search</span></a>
                                    <ul>
                                ...
                                <li>
                                    <a class="nav-submenu" data-toggle="nav-submenu" href="#"><i class="si si-wrench"></i><span class="sidebar-mini-hide">Services</span></a>
                                    <ul>
                                       
                                      
                                        <li>
                                            <a href="czt.php">Create Services</a>
                                        </li>
                                        <li>
                                            <a href="subcategory.php">Sub Services</a>
                                        </li>
                                        <li>
                                            <a href="insert-products.php">Add Services</a>
                                        </li>
                                        <li>
                                            <a href="manage-products.php">Manage Services</a>
                                        </li>
