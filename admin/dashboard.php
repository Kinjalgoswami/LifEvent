...
?>
                        ...
                        <div class="col-6 col-md-4 col-xl-3">
                            <a class="block text-center" href="todays-orders.php">
...
?>
                        ...
                        <div class="col-6 col-md-4 col-xl-3">
                            <a class="block text-center" href="insert-products.php">
                                <div class="block-content ribbon ribbon-bookmark ribbon-crystal ribbon-left bg-gd-sea">
                                   <?php 
...
?> 
                                   ...
                                   <p class="mt-5">
                                    ...
                                    <p class="font-w600 text-white">Add Services</p>
                                </div>
                            </a>
                        </div>
                ...
                <div class="content">
                    <div class="row gutters-tiny invisible" data-toggle="appear">
                        ...
                        <div class="col-6 col-md-4 col-xl-4">
                            <a class="block text-center" href="manage-products.php">
                                <div class="block-content ribbon ribbon-bookmark ribbon-crystal ribbon-left bg-gd-dusk">
                                    <?php 
...
?>
                                    ...
                                    <p class="font-w600 text-white">Manage Services</p>
                                </div>
                            </a>
                        </div>
                        <!--<div class="col-6 col-md-4 col-xl-4">
...
?>
                        ...
                        <div class="col-6 col-md-4 col-xl-4">
                            <a class="block text-center" href="booking-search.php">
                                <div class="block-content ribbon ribbon-bookmark ribbon-crystal ribbon-left bg-gd-sea">
